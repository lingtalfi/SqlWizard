...
Source Code
===========
See the source code for method [MysqlStructureReader::extractEngine](https://github.com/lingtalfi/SqlWizard/blob/master/Util/MysqlStructureReader.php#L622-L629)
